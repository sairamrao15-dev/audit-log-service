...
public record BatchEventRequest(
    ...
    public BatchEventRequest(String idempotencyKey, String eventType, JsonNode payload,
                             Instant occurredAt, UUID eventId) {
        this(idempotencyKey, eventType, null, null, null, payload, null, occurredAt, eventId);
    }
